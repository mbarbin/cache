...
- Implementation is written collaboratively: human and AI both act on the task, with the human shaping and understanding the result throughout.
- Tests and documentation are AI-driven: the AI acts on the whole task, checking in with the human for permission or clarification along the way.
